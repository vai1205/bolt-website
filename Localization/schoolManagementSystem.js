module.exports = {
	...
	feature1Para : 'Our easy to use mobile app not only provides features to conduct online classes but it also have got full fledged Fee submission, Quiz/Exam conduction and attendance report modules. With simple and self explanatory User Interface of the app, we make it more convenient for parent and child to take the most benefit out of it, and with the Highly customizable admin panel, we provide controls to each and every bits of the app to the School Management.',
